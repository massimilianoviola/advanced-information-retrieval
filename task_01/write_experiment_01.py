...
output_path = "task_01/outputs" # save search script outputs
result_path = "task_01/results" # save analysis made by trec_eval
...
file = open("task_01/experiment_01.sh", "w") if args.file else sys.stdout

# write the experiment in shell language to be executed via the command line
printf = functools.partial(print, file=file)

printf("# experiment 01: compare retrieval performance with language models")
